...
config :basic, Basic.Repo,
  database: Path.expand("../basic_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :basic, BasicWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xnP/YjMZE5WuEBBCmxW/e8W3Ko/FV8F5I1UkGETwYco2FLWHuhFM1YEKPJln4kvL",
  watchers: [
...
config :basic, BasicWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/basic_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
